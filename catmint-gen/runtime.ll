; ModuleID = 'catmint_runtime.c'
source_filename = "catmint_runtime.c"
...
%struct.TObject = type { %struct.__catmint_rtti* }
%struct.TIO = type { %struct.__catmint_rtti* }

@.str = private unnamed_addr constant [7 x i8] c"Object\00", align 1
@NObject = dso_local global %struct.TString { %struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*), i32 6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0) }, align 8
@.str.1 = private unnamed_addr constant [7 x i8] c"String\00", align 1
@NString = dso_local global %struct.TString { %struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*), i32 6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0) }, align 8
@.str.2 = private unnamed_addr constant [3 x i8] c"IO\00", align 1
@NIO = dso_local global %struct.TString { %struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*), i32 2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0) }, align 8
@RObject = dso_local global { %struct.TString*, i32, %struct.__catmint_rtti*, [3 x i8*] } { %struct.TString* @NObject, i32 8, %struct.__catmint_rtti* null, [3 x i8*] [i8* bitcast (void (%struct.TObject*)* @M6_Object_abort to i8*), i8* bitcast (%struct.TString* (%struct.TObject*)* @M6_Object_typeName to i8*), i8* bitcast (%struct.TObject* (%struct.TObject*)* @M6_Object_copy to i8*)] }, align 8
@RString = dso_local global { %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] } { %struct.TString* @NString, i32 24, %struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [3 x i8*] }* @RObject to %struct.__catmint_rtti*), [8 x i8*] [i8* bitcast (void (%struct.TObject*)* @M6_Object_abort to i8*), i8* bitcast (%struct.TString* (%struct.TObject*)* @M6_Object_typeName to i8*), i8* bitcast (%struct.TObject* (%struct.TObject*)* @M6_Object_copy to i8*), i8* bitcast (i32 (%struct.TString*)* @M6_String_length to i8*), i8* bitcast (i32 (%struct.TString*)* @M6_String_toInt to i8*), i8* bitcast (%struct.TString* (%struct.TString*, i32, i32)* @M6_String_substring to i8*), i8* bitcast (%struct.TString* (%struct.TString*, %struct.TString*)* @M6_String_concat to i8*), i8* bitcast (i32 (%struct.TString*, %struct.TString*)* @M6_String_equal to i8*)] }, align 8
@RIO = dso_local global { %struct.TString*, i32, %struct.__catmint_rtti*, [5 x i8*] } { %struct.TString* @NIO, i32 8, %struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [3 x i8*] }* @RObject to %struct.__catmint_rtti*), [5 x i8*] [i8* bitcast (void (%struct.TObject*)* @M6_Object_abort to i8*), i8* bitcast (%struct.TString* (%struct.TObject*)* @M6_Object_typeName to i8*), i8* bitcast (%struct.TObject* (%struct.TObject*)* @M6_Object_copy to i8*), i8* bitcast (%struct.TString* (%struct.TIO*)* @M2_IO_in to i8*), i8* bitcast (%struct.TIO* (%struct.TIO*, %struct.TString*)* @M2_IO_out to i8*)] }, align 8
...
define dso_local %struct.TString* @M6_Object_typeName(%struct.TObject* %0) #0 {
  ...
  %5 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %4, align 8
  %6 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %5, i32 0, i32 0
...
define dso_local %struct.TObject* @M6_Object_copy(%struct.TObject* %0) #0 {
  ...
  %6 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %5, align 8
  %7 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %6, i32 0, i32 1
  ...
  %18 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %17, align 8
  %19 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %18, i32 0, i32 1
...
22:                                               ; preds = %14
  %23 = call i8* @__catmint_new(%struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*))
...
define dso_local %struct.TString* @M6_String_concat(%struct.TString* %0, %struct.TString* %1) #0 {
  ...
  %14 = call i8* @__catmint_new(%struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*))
...
define dso_local %struct.TString* @M2_IO_in(%struct.TIO* %0) #0 {
  ...
  %7 = call i8* @__catmint_new(%struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*))
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @__catmint_new(%struct.__catmint_rtti* %0) #0 {
  %2 = alloca %struct.__catmint_rtti*, align 8
  %3 = alloca i8*, align 8
  store %struct.__catmint_rtti* %0, %struct.__catmint_rtti** %2, align 8
  %4 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %2, align 8
  %5 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %4, i32 0, i32 1
  %6 = load i32, i32* %5, align 8
  %7 = sext i32 %6 to i64
  %8 = call noalias i8* @malloc(i64 %7) #7
  store i8* %8, i8** %3, align 8
  %9 = load i8*, i8** %3, align 8
  %10 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %2, align 8
  %11 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %10, i32 0, i32 1
  %12 = load i32, i32* %11, align 8
  %13 = sext i32 %12 to i64
  call void @llvm.memset.p0i8.i64(i8* align 1 %9, i8 0, i64 %13, i1 false)
  %14 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %2, align 8
  %15 = load i8*, i8** %3, align 8
  %16 = bitcast i8* %15 to %struct.TObject*
  %17 = getelementptr inbounds %struct.TObject, %struct.TObject* %16, i32 0, i32 0
  store %struct.__catmint_rtti* %14, %struct.__catmint_rtti** %17, align 8
...
define dso_local i8* @__lcpl_cast(i8* %0, %struct.__catmint_rtti* %1) #0 {
  ...
  %6 = alloca %struct.__catmint_rtti*, align 8
  %7 = alloca %struct.__catmint_rtti*, align 8
  store i8* %0, i8** %4, align 8
  store %struct.__catmint_rtti* %1, %struct.__catmint_rtti** %5, align 8
...
11:                                               ; preds = %2
  ...
  %15 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %14, align 8
  store %struct.__catmint_rtti* %15, %struct.__catmint_rtti** %6, align 8
  %16 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %6, align 8
  store %struct.__catmint_rtti* %16, %struct.__catmint_rtti** %7, align 8
  br label %17

17:                                               ; preds = %26, %11
  %18 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %7, align 8
  %19 = icmp ne %struct.__catmint_rtti* %18, null
  br i1 %19, label %20, label %30

20:                                               ; preds = %17
  %21 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %7, align 8
  %22 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %5, align 8
  %23 = icmp eq %struct.__catmint_rtti* %21, %22
...
26:                                               ; preds = %20
  %27 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %7, align 8
  %28 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %27, i32 0, i32 2
  %29 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %28, align 8
  store %struct.__catmint_rtti* %29, %struct.__catmint_rtti** %7, align 8
  br label %17

30:                                               ; preds = %17
  %31 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %6, align 8
  %32 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %31, i32 0, i32 0
  ...
  %36 = load %struct.__catmint_rtti*, %struct.__catmint_rtti** %5, align 8
  %37 = getelementptr inbounds %struct.__catmint_rtti, %struct.__catmint_rtti* %36, i32 0, i32 0
...
define dso_local %struct.TString* @__lcpl_intToString(i32 %0) #0 {
  ...
  %9 = call i8* @__catmint_new(%struct.__catmint_rtti* bitcast ({ %struct.TString*, i32, %struct.__catmint_rtti*, [8 x i8*] }* @RString to %struct.__catmint_rtti*))
