 ...
 */
  ...
  */
  ...
  /*! This function adopts the GoF visitor pattern.
     ...
     is a Handler.
      It can also be used to deep clone this value via GenericDocument, which is
     also a Handler.
...
private:
  ...
  // to MaxSize chars
  // (excluding the terminating zero) and store a value to determine the length
  // of the contained
  ...
  // therefore act as
  // the string terminator as well. For getting the string length back from that
  // value just use
  // "MaxSize - str[LenPos]".
  // This allows to store 11-chars strings in 32-bit mode and 15-chars strings
  // in 64-bit mode
...
private:
  ...
  void ClearStack() {
    if (Allocator::kNeedFree)
      while (stack_.GetSize() > 0) // Here assumes all elements in stack array
